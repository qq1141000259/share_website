...
request.interceptors.response.use(response =>{
    ...
    if(resp.code !== 0) {
        ...
        if(resp.code == 99999){
            localStorage.removeItem('share-website-token')
            localStorage.removeItem('share-website-user')
...
// export const defaultReq, request
